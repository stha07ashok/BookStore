...
const Dashboard = () => {
  ...
  return (
    <>
      <section className="grid md:grid-cols-2 xl:grid-cols-2 gap-6 items-center justify-center">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Total Sold Books</span>
          </div>
        </div>
      </section>
    </>
