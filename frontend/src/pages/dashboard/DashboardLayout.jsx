  ...
  return (
    <section className="flex md:bg-gray-100 min-h-screen overflow-hidden">
      <aside className="hidden sm:flex sm:flex-col">
        <div className="inline-flex items-center justify-center h-20 w-20 bg-purple-600 focus:bg-purple-500">
        ...
        <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
          ...
          <div className="inline-flex items-center justify-center h-20 w-20 border-t border-gray-700"></div>
        </div>
      </aside>
